...
import com.github.minecraft_ta.totaldebug.util.MethodReferenceSearcher;
...
public class SearchReferenceCommand extends CommandBase {
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args) throws CommandException {
        ...
        CompletableFuture<Collection<String>> future = MethodReferenceSearcher.findMethodReferences(args[0]);
        if (future == null) {
        ...
        future.exceptionally(e -> {
            ...
            Minecraft.getMinecraft().addScheduledTask(() -> {
                ...
                sender.sendMessage(new TextComponentTranslation("commands.total_debug.searchreference.result_count", results.size()).setStyle(new Style().setColor(TextFormatting.GREEN))
                        .appendText(" ")
