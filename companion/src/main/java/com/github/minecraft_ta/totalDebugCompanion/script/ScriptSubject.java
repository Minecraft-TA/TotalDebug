 ...
 */
public record ScriptSubject(SubjectRef.Occurrence subject, String gameSessionId, String expectedId) {
    ...
    public ScriptSubject(SubjectRef.Occurrence subject, String gameSessionId) {
