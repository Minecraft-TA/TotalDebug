 ...
 * Clicking it collapses or expands the section, shown by the tree's chevron.
 */
public final class SectionHeading extends JPanel {
    private final JLabel title = new JLabel();
    private boolean collapsed;

    /** {@code trailing} sits right of the rule, such as a count of omitted entries; it may be null. */
    ...
    private void showChevron() {
        this.title.setIcon(UIManager.getIcon(this.collapsed ? "Tree.collapsedIcon" : "Tree.expandedIcon"));
    }
}
