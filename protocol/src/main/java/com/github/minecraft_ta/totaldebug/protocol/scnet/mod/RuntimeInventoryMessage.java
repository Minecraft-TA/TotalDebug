...
public final class RuntimeInventoryMessage extends AbstractMessageOutgoing {
    ...
    private final RuntimeInventoryPayload payload;
    ...
    public static RuntimeInventoryMessage preparing(String detail) { return new RuntimeInventoryMessage(PREPARING, "", "", Objects.requireNonNull(detail)); }
    public static RuntimeInventoryMessage available(String id, String file) { return new RuntimeInventoryMessage(AVAILABLE, Objects.requireNonNull(id), Objects.requireNonNull(file), ""); }
    public static RuntimeInventoryMessage failed(String detail) { return new RuntimeInventoryMessage(FAILED, "", "", Objects.requireNonNull(detail)); }
