...
/** Protocol-15 payloads, kept independently of the encoder. */
public final class GoldenMessages {
    ...
    public static final String CLIENT_HELLO = "0000000f00000003616263000000017000000001640000000177";
    public static final String SERVER_HELLO = "0000000f0100000000";
