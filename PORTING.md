...
| F6 | Live reference search | Not started | The runtime-source inventory is sufficient for references in physical class files; references introduced only by runtime transformation remain deferred with F3b |
